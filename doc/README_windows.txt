...
Intro
-----
Mgpcoin (MGP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Mgpcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run mgpcoin-qt.exe.

Mgpcoin is the original Mgpcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Mgpcoin transactions;
