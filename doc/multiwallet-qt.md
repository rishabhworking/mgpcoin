...
In order to support loading of multiple wallets in mgpcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mgpcoin.cpp.
...
Changes to mgpcoin.cpp
----------------------
mgpcoin.cpp is the entry point into mgpcoin-qt, and as such, will require some minor modifications to provide hooks for
