...
RESOURCES += src/qt/mgpcoin.qrc src/qt/mgpcoin_locale.qrc

TRANSLATIONS += src/qt/locale/mgpcoin_bg.ts \
                src/qt/locale/mgpcoin_de.ts \
                src/qt/locale/mgpcoin_en.ts \
                src/qt/locale/mgpcoin_es.ts \
                src/qt/locale/mgpcoin_fi.ts \
                src/qt/locale/mgpcoin_fr.ts \
                src/qt/locale/mgpcoin_it.ts \
                src/qt/locale/mgpcoin_ja.ts \
                src/qt/locale/mgpcoin_pl.ts \
                src/qt/locale/mgpcoin_pt.ts \
                src/qt/locale/mgpcoin_ru.ts \
                src/qt/locale/mgpcoin_sk.ts \
                src/qt/locale/mgpcoin_sv.ts \
                src/qt/locale/mgpcoin_vi.ts \
                src/qt/locale/mgpcoin_zh_CN.ts \
                src/qt/locale/mgpcoin_zh_TW.ts
