Contributing to Mgpcoin
==================================

The Mgpcoin project operates an open contributor model where anyone is
...
The following applies to code changes to the Mgpcoin project, and is not to be
confused with overall Mgpcoin Network Protocol consensus changes.

Whether a pull request is merged into Mgpcoin rests with the project merge
...
Patches that change Mgpcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mgpcoin consensus, it must have been
...
The project leader is the release manager for each Mgpcoin release.
