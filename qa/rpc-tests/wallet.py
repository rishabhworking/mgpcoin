...
#   c) node1 mines 32 blocks, so now node 0 has 500000MGP, node 1 has 4250MGP, node2 has none.
#   d) node0 sends 601 MGP to node2, in two transactions (301 MGP, then 300 MGP).
