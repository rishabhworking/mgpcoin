...
/** Utility functions used by the Mgpcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MGP addresses in monospace font
...
// Parse "mgpcoin:" URI into recipient object, return true on successful parsing
