                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mgpcoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MGP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mgpcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mgpcoin"), this);
    aboutAction->setStatusTip(tr("Show information about Mgpcoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mgpcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MGP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MGP addresses"));
    ...
    openAction->setStatusTip(tr("Open a mgpcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mgpcoin help message to get a list with possible Mgpcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mgpcoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mgpcoin network", "", count));
}
...
{
    QString strTitle = tr("Mgpcoin"); // default title
