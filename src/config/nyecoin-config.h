/* src/config/mgpcoin-config.h.  Generated from mgpcoin-config.h.in by configure.  */
/* src/config/mgpcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "Mgpcoin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mgpcoin 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mgpcoin"
