...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Mgpcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mgpcoin features */
        {"Mgpcoin", "masternode", &masternode, true, true, false},
        {"Mgpcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"Mgpcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Mgpcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Mgpcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Mgpcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"Mgpcoin", "startmasternode", &startmasternode, true, true, false},
        {"Mgpcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Mgpcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Mgpcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Mgpcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Mgpcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Mgpcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Mgpcoin", "mnbudget", &mnbudget, true, true, false},
        {"Mgpcoin", "preparebudget", &preparebudget, true, true, false},
        {"Mgpcoin", "submitbudget", &submitbudget, true, true, false},
        {"Mgpcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Mgpcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Mgpcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Mgpcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Mgpcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Mgpcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Mgpcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Mgpcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"Mgpcoin", "mnsync", &mnsync, true, true, false},
        {"Mgpcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> Mgpcoin-cli " + methodname + " " + args + "\n";
}
